...
public class AppliConfigService {
	...
	enum AppliConfigKey {
		...
		BEFORE_START_EMARGER_LINK, ADE_CATEGORIES, ADE_IMPORT_MEMBERS, ADE_ENABLED,  ESUPSIGNATURE_ENABLED, ESUPSIGNATURE_EMAILS, ATTESTATION_TEXTE, TRI_BADGEAGE_ALPHA, QRCODE_CHANGE
	}
