...
public class LogService {
	...
	public static enum ACTION {
		...
		SEND_PDF_EXPORT, ADE_IMPORT, ADE_SYNC, GET_QRCODESESSION, TASK_CREATE, TASK_UPDATE, TASK_DELETE, DELETE_ABSENCE, CREATE_MOTIF_ABSENCE, UPDATE_MOTIF_ABSENCE,
		DELETE_MOTIF_ABSENCE, CREATE_STATUTS_SESSION, CREATE_HELP
