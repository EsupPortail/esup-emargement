...
public class LogService {
	...
	public static enum ACTION {
		...
		UPDATE_SESSION_EPREUVE, DELETE_SESSION_EPREUVE, EXECUTE_REPARTITION, RESET_REPARTITION, AJOUT_SESSION_LOCATION,
		...
		AJOUT_EVENT, UPDATE_EVENT, DELETE_EVENT, SWITCH_USER
